...
<head>
    ...
    <title>Return Policy - Geevic</title>
...
<body class="body">
      ...
      <section id="privacy-h" class="container pt-3">
        <div class="priv-div">
        <h3 class="priv-h1">Return Policy</h3>
          <span class="priv-spans">
          We work hard to provide each and every customer with the finest experience imaginable. Please feel free to get in touch with us if you have any queries regarding our goods or services at Geevichfoods@gmail.com or +1 317-689-9743.
          We are delighted to assist you with the following choice if you are not satisfied.
          </span>
        </div>
      ...
      <section class="container">
        <div id="priv-body">
        <h4 class="priv-h1">Food Item Return</h4>
              <span class="priv-spans">
      spices, grains, and other food products that are defective or damaged may be exchanged within 30 days of the initial purchase. 
      Due to health and safety considerations, once the exterior shipping box has been opened, we are unable to accept any returns on non-defective/damaged food goods.
      To begin the exchange procedure, please call us @ +1 317-689-9743, or send an email to Geevichfoods@gmail.com.
              </span> <br><br>
